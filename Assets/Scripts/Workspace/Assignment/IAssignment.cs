...
namespace Assignment
{
    ...
    public interface IAssignment
    {
        ...
        // AS10_GameEventQueue accepts a LinkedList of GameEvent objects and processes the next event in the queue.
        public void AS10_GameEventQueue(LinkedList<GameEvent> eventQueue);

        // AS11_PlayerStatsTracker accepts a Dictionary of player statistics and updates a specific stat by adding a value.
        public void AS11_PlayerStatsTracker(Dictionary<string, int> playerStats, string statName, int value);
